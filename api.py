...
def pyep_get_media(slug, name, type, format=None, token=None, stream=True):
    """ Get Media data
    ...
    :type format: str
    """
    url = '{}/export/media/{}'.format(REQ_URL, slug)
...
def pyep_download_media(slug, name, type, format=None, path=None, token=None,
                   stream=True):
    """ Download Media data
